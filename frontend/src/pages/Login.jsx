...
import { signIn } from "../js/account.js";
      ...
      <div className="centered-box">
        <form
          ...
          onSubmit={async function (event) {
            ...
            // Is removed in App.jsx on change of firebase state
            let spinner = document.getElementById("spinner");
            spinner.className = "spinner-border ms-auto";

            await signIn(props.firebase.auth).then((result) => {
              if (result) {
        ...
        >
          ...
          <div className="row text-center my-3">
            <input type="email" className="form-control" id="signInMail" placeholder="Email" required />
          </div>

          <div className="row text-center my-3">
            <input type="password" className="form-control" id="signInPassword" placeholder="Password" required />
          </div>
